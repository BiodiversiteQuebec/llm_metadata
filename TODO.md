...
- [x] `R2-A`: direct LLM classification from abstract / repository-description text in `notebooks/relevance_llm_direct.ipynb`
- [x] `R2-B`: direct LLM classification from PDF files in `notebooks/relevance_llm_direct_pdf.ipynb`
...
- [x] WU-R6: Fresh `R2-A` / `R2-B` rerun with valid OpenAI credentials and split nomenclature refresh
