...
from llm_metadata.gpt_classify import classify_abstract, extract_text_from_pdf
...
class PDFClassificationConfig:
    ...
    Attributes:
        ...
        max_pdf_pages: Maximum pages to extract (None = all pages)
...
class PDFOutputRecord(BaseModel):
    ...
    pdf_text_tokens: Optional[int] = Field(None, description="Extracted text token count")
    pages_extracted: Optional[int] = Field(None, description="Number of pages extracted")
